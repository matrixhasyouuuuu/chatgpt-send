...
sleep 5
if [[ -n "${out:-}" ]]; then
  printf '%s\n' 'CHILD_RESULT: early gate stuck test done' >"$out"
fi
printf '%s\n' 'CHILD_RESULT: early gate stuck test done'
EOF
chmod +x "$fake_codex"
...
https://chatgpt.com/c/6994c413-7cb4-8388-81a3-1d6ee4312c01
https://chatgpt.com/c/6994c413-7cb4-8388-81a3-1d6ee4312c02
https://chatgpt.com/c/6994c413-7cb4-8388-81a3-1d6ee4312c03
EOF
...
if [[ "$rc" == "0" ]]; then
  echo "expected non-zero rc on early abort trigger" >&2
  exit 1
fi
